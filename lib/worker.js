    ...
    if ((error.code === 'ENOTDIR' || error.code === 'ERR_MODULE_NOT_FOUND') &&
     filename.startsWith('file://')) {
      ...
      try {
        ...
        // If require also fails with a non-module-resolution error,
        // it is a runtime error in the loaded module (e.g. ReferenceError, TypeError).
        // Surface that instead of masking it with the original import error.
