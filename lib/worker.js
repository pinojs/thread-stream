    ...
    if ((error.code === 'ENOTDIR' || error.code === 'ERR_MODULE_NOT_FOUND') &&
     filename.startsWith('file://')) {
      ...
      try {
        ...
        // Surface runtime errors from the loaded module (e.g. ReferenceError, TypeError).
        // These indicate actual bugs in the worker module code.
        // Other require errors (MODULE_NOT_FOUND, ERR_REQUIRE_ESM, etc.) mean
        // the file couldn't be loaded via require — fall back to the original import error.
        // More info at: https://github.com/pinojs/thread-stream/issues/156
        if (requireError instanceof ReferenceError ||
          requireError instanceof TypeError ||
          requireError instanceof RangeError) {
          throw requireError
        }
        throw error
      }
